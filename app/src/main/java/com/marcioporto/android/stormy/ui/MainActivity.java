...
import com.marcioporto.android.stormy.weather.Current;
import com.marcioporto.android.stormy.weather.Day;
import com.marcioporto.android.stormy.weather.Forecast;
import com.marcioporto.android.stormy.weather.Hour;
...
public class MainActivity extends ActionBarActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    @InjectView(R.id.precipitationValue) TextView mPrecipitationValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final double latitude = 44.9438;
        //final double longitude = -93.0933;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "a435f34f753ccaad3703c5d02cf43f1e";
    ...
    private void updateDisplay() {
        ...
        mPrecipitationValue.setText(current.getPrecipitationChance() + "%");
